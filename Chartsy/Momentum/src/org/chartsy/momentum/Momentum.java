...
public class Momentum extends Indicator{
    ...
    @Override
    public Indicator newInstance(){ return new Momentum(); }
    ...
    public void calculate()
    {
        ...
        lookback = core.momLookback(period);
        core.mom(0, count-1, initial.getCloseValues(), period, outBegIdx, outNbElement, output);
