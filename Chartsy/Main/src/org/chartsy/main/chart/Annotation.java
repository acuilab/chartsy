...
public abstract class Annotation implements Serializable, MouseListener, MouseMotionListener {
    ...
    public static final int TOP = 1;            // 上
    public static final int TOP_LEFT = 2;       // 左上
    public static final int TOP_RIGHT = 3;      // 右上
    public static final int LEFT = 4;           // 左
    public static final int RIGHT = 5;          // 右
    public static final int BOTTOM = 6;         // 下
    public static final int BOTTOM_LEFT = 7;    // 左下
    public static final int BOTTOM_RIGHT = 8;   // 右下
    public static final int CENTER = 9;         // 中心
    ...
    protected transient ChartFrame chartFrame;              // 图表窗口
