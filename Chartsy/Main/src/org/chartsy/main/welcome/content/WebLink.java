...
public class WebLink extends LinkButton {
    ...
    public static WebLink createWebLink(String key) {
        return new WebLink(key, false);
    }

    public static WebLink createWebLink(String key, boolean showBullet) {
        return new WebLink(key, showBullet);
    }

    public static WebLink createWebLink(String label, String url) {
        return new WebLink(label, url, false);
    }

    public static WebLink createWebLink(String label, String url, boolean showBullet) {
        return new WebLink(label, url, showBullet);
    }
