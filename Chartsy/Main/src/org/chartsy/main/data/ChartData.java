...
public class ChartData implements Serializable, ChartFrameListener {
    ...
    private Interval interval;                  // 间隔
    private Chart chart;                        // 图表
    private String dataProviderName;            // 数据提供者名称
    private String datasetKey;                  // 数据集key
    private Dataset visible;                    // 可见数据集
    private Range visibleRange;                 // 可见范围
    private List<Indicator> savedIndicators;    // 保存的指标
