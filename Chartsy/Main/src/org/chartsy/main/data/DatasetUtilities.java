...
public final class DatasetUtilities {
    ...
    public static final int OPEN_PRICE = 0;     // 开盘价
    public static final int HIGH_PRICE = 1;     // 最高价
    public static final int LOW_PRICE = 2;      // 最低价
    public static final int CLOSE_PRICE = 3;    // 收盘价
    public static final int VOLUME_PRICE = 4;   // 数量
