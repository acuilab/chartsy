...
public class SymbolChanger extends JToolBar implements Serializable {
    ...
    private JTextField txtSymbol;       // 代码文本域
    private JButton btnSubmit;          // 提交按钮
    private JButton btnBack;            // 后退按钮
    private JButton btnForward;         // 前进按钮
    private JButton btnBackHistory;     // 后退历史按钮
    private JButton btnForwardHistory;  // 前进历史按钮
    private String dataProvider;        // 数据提供者
    private boolean canOpen = true;     // 是否可以打开
