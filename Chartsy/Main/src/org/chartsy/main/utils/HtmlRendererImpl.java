...
public class HtmlRendererImpl extends JLabel implements HtmlRenderer.Renderer {
    ...
    protected void configureFrom(Object value, JComponent target, boolean selected, boolean leadSelection) {
        if (value == null) {
            value = "";
        }
    ...
    protected @Override
    final void firePropertyChange(String name, Object old, Object nue) {
        if (swingRendering) {
