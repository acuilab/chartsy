...
public final class XMLUtil {
    ...
    public static Element addChartNode(Document document, Element parent, Chart chart) {
    ...
    public static Element addOverlaysNode(Document document, Element parent) {
        Element element = document.createElement(OVERLAYS_NODE);
        parent.appendChild(element);
        return element;
    }

    public static Element addOverlayNode(Document document, Element parent, Overlay overlay) {
    ...
    public static Element addIndicatorsNode(Document document, Element parent) {
        Element element = document.createElement(INDICATORS_NODE);
        parent.appendChild(element);
        return element;
    }

    public static Element addIndicatorNode(Document document, Element parent, Indicator indicator) {
